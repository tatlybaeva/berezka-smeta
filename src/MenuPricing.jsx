...
const initialSections = [
  {
    ...
    items: [
      ...
      { name: "Травяной чай", cost: 2, price: 12, note: "" },
      { name: "Água com gás (газ. вода)", cost: 2, price: 8, note: "" },
      { name: "Água sem gás (вода)", cost: 1, price: 6, note: "" },
      { name: "Suco / Refrigerante", cost: 4, price: 9, note: "из холодильника" },
    ]
  },
  {
    id: "breakfast",
    title: "☀️ Завтраки — КОНСТРУКТОР до 11:00",
    color: "#EAF3DE",
    text: "#3B6D11",
    items: [
      { name: "БАЗА: Блины × 3 (со сметаной + варенье)", cost: 8, price: 28, note: "" },
      { name: "БАЗА: Сырники × 3 (со сметаной + варенье)", cost: 10, price: 32, note: "" },
      { name: "БАЗА: Драники × 3 (со сметаной + варенье)", cost: 8, price: 28, note: "" },
      { name: "ДОБАВКА: Лосось слабосолёный 50г", cost: 9, price: 18, note: "высокая маржа как доп" },
      { name: "ДОБАВКА: Яйца 2 шт", cost: 3, price: 8, note: "" },
      { name: "ДОБАВКА: Каша молочная (рис/овёс/дружба)", cost: 5, price: 15, note: "высокая маржа" },
      { name: "ДОБАВКА: Творог со сметаной", cost: 3, price: 8, note: "" },
      { name: "Яичница с колбасой из индейки", cost: 12, price: 35, note: "отдельное блюдо" },
      { name: "Яйца Бенедикт", cost: 14, price: 42, note: "отдельное блюдо" },
    ]
  },
  {
    id: "lunch",
    ...
    text: "#0C447C",
    items: [
      { name: "Борщ (порция 350мл + хлеб)", cost: 12, price: 38, note: "" },
      { name: "Уха (порция 350мл)", cost: 15, price: 42, note: "рыба — следить за ценой" },
      { name: "Рассольник (порция 350мл)", cost: 10, price: 35, note: "" },
      { name: "Котлеты с пюре (2 шт)", cost: 22, price: 55, note: "закуп R$90/кг — делать порции 150г" },
      { name: "Бефстроганов", cost: 20, price: 58, note: "" },
      { name: "Пельмени (250г)", cost: 25, price: 65, note: "⚠️ закуп R$90/кг — рентабельнее лепить самим" },
      { name: "Вареники с картошкой (250г)", cost: 12, price: 48, note: "лепить самим — хорошая маржа" },
      { name: "Лосось с кус-кусом", cost: 22, price: 62, note: "" },
      { name: "Квашеная капуста (порция)", cost: 4, price: 18, note: "очень высокая маржа" },
      { name: "Дачный салат", cost: 8, price: 28, note: "" },
    ]
  },
  {
    id: "baking",
    title: "🥐 Выпечка и десерты — весь день",
    color: "#EEEDFE",
    text: "#3C3489",
    items: [
      { name: "Чак-чак (порция)", cost: 8, price: 28, note: "мёд дорогой — следить" },
      { name: "Эчпочмак (1 шт)", cost: 6, price: 18, note: "" },
      { name: "Бэлэш (порция)", cost: 8, price: 24, note: "" },
      ...
      { name: "Пирожное картошка (1 шт)", cost: 5, price: 18, note: "" },
    ]
  },
];
