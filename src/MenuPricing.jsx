...
const initialSections = [
  ...
  {
    id: "lemonades",
    title: "🍋 Лимонады — весь день",
    color: "#FFFDE7",
    text: "#827717",
    items: [
      { name: "Классический (лимон + мята + газ)", cost: 5, price: 18, note: "концентрат цеха + газировка" },
      { name: "Клубничный (клубника + лимон + газ)", cost: 7, price: 22, note: "концентрат цеха" },
      { name: "Малиновый (малина + лимон + газ)", cost: 7, price: 22, note: "концентрат цеха" },
      { name: "Огуречный (огурец + лимон + мята + газ)", cost: 5, price: 20, note: "концентрат цеха" },
      { name: "Имбирный (имбирь + лимон + мёд + газ)", cost: 6, price: 22, note: "концентрат цеха" },
    ]
  },
  {
    id: "breakfast",
